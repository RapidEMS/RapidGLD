...
public class SimToolBar extends GLDToolBar
{
	...
	protected void addTools() {
  	addButton("src/main/java/com/github/RapidEMS/images/edgenode.gif", this, EDGENODE);
  	
  	addSeparator();
  	
  	addButton("src/main/java/com/github/RapidEMS/images/step.gif", this, STEP);
  	addButton("src/main/java/com/github/RapidEMS/images/run.gif", this, RUN);
  	addButton("src/main/java/com/github/RapidEMS/images/pause.gif", this, PAUSE);
  	addButton("src/main/java/com/github/RapidEMS/images/stop.gif", this, STOP);
